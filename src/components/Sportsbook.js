						...
						<TableRow>
							<th className='gameInfo'>
									<div className='eventCell'>
										...
										<div className='teamInfo'>
											...
											<a className='team1'>LV Raiders</a>
										</div>
									</div>
							</th>
							<td className='lineCol'>
								<div className='lineContainer'>
									...
									<div className='lineodds'>-105</div>
								</div>
							</td>
							<td className='lineCol'>
								<div className='lineContainer'>
									<div className='line'>O 51.5</div>
									<div className='lineodds'>-115</div>
								</div>
							</td>
							<td className='lineCol'>
								<div className='lineContainer'>
									<div className='lineodds'>+290</div>
								</div>
							</td>
						</TableRow>
						<tr>
							...
							<td className='line2Col'>
								<div className='lineContainer'>
									<div className='line'>U 51.5</div>
									<div className='lineodds'>-105</div>
								</div>
							</td>
							<td className='line2Col'>
								<div className='lineContainer'>
									<div className='lineodds'>-350</div>
								</div>
							</td>
						</tr>
					</GameCard>
