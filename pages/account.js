        ...
        {isSuccess ? (
            <div className="body">
                ...
                <div className="userEmail setting">
                    ...
                    <button type="submit" onClick={handleEmail}>Change Email!</button>
                </div>
                <div className="userName setting">
                    {user.username}
                    <input placeholder="Change Username" type="text" ref={userRef} />
                    <button type="submit" onClick={handleUsername}>Change Username!</button>
                </div>
                <div className="userPass setting">
                    <input placeholder="Change Password" type="password" ref={passRef} />
                    <button type="submit" onClick={handlePassword}>Change Password!</button>
                </div>
