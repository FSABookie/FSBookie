  ...
  return (
    <Container>
      ...
      <Odds>
        ...
        <h1>MONEYLINE</h1>
        <h3>Learn all about what the moneyline is and how to bet on it.</h3>
      ...
      <Overview>
        ...
        <p className="moneylineInfo">
          A moneyline is simply a bet type that only includes Odds, as in “Odds
          to win”.
        </p>
        <p className="moneylineInfo">
          Example: a moneyline of +150, is just +150 odds ($100 to win $150) for
          the listed team to win. A moneyline of -150 is just -150 odds ($150 to
          win $100) for the listed team to win.
        </p>
      ...
      <BetTypes>
        ...
        <div className="getStarted">
          <Link href="/help/spreadbetting">Spread</Link>
        </div>
      </BetTypes>
    </Container>
  );
